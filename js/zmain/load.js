var loadState = {
  preload: function() {
    ...
    PrisonBreak.game.load.image('background_menuLvl', 'assets/bgs/menuLvl_bg.png');
    PrisonBreak.game.load.image('prisonHouse', 'assets/bgs/prisonhouse.png');
    ...
    PrisonBreak.game.load.image('bgm_off', 'assets/bgm_off.png');
